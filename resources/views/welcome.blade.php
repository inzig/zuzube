            ...
            <div class="slide">
                <div class="auto-container">
                	<div class="clearfix">
						<div class="content">
							<h1>ZUZUBE</h1>
							<h2>Manage all of you stuff using <br> one app Solution.</h2>
							<div class="text">Lorem Ipsum is simply dummy text of the printing and typesetting industry.</div>
							<div class="link-box">
								<a href="#" class=""><img src="images/and.png" width="175px;" alt=""></a>
								<a href="#" class=""><img src="images/apple.png" width="175px;" alt=""></a>
				...
				<div class="outer-row clearfix">
					...
					<div class="software-block-two">
						<div class="inner-box wow fadeInRight animated" data-wow-delay="0ms" data-wow-duration="1500ms" style="visibility: visible; animation-duration: 1500ms; animation-delay: 0ms; animation-name: fadeInRight;">
							...
							<h3><a href="#">Website Auditor</a></h3>
							<div class="text">Keyword research &amp; ranking sure every step of you SEO Campaign is taken care.</div>
						</div>
					</div>
				</div>
                ...
                <div class="row clearfix">
                    ...
                    <div class="col-lg-3 col-md-12 col-sm-12">
                        ...
                        <ul class="tab-btns tab-buttons clearfix">
                            <li data-tab="#prod-modern" class="tab-btn">Modern Tecnology</li>
                            <li data-tab="#prod-friendly" class="tab-btn active-btn">Friendly Use</li>
                            <li data-tab="#prod-face" class="tab-btn">Face ID</li>
                            <li data-tab="#prod-woreless" class="tab-btn">Wireless Charging</li>
                            <li data-tab="#prod-sensor" class="tab-btn">New Sensor</li>
                        </ul>
                    </div>
                    <!--Column-->
				...
				<div class="inner-box">
					<div class="row clearfix">
						...
						<div class="content-column col-lg-6 col-md-6 col-sm-12">
							<div class="inner-column">
								<div class="sec-title">
									<h2>Your app activity count</h2>
									<div class="separater"></div>
								</div>
								<div class="text">Comprehensivese SEO involves keywords research and ranking tracking, on-site optimizations, backlink analysis, and link the building for your company.</div>
								<a href="#" class="theme-btn btn-style-seven">See More</a>
							</div>
						</div>
						<!--Image Column-->
	...
	<section class="testimonial-section-two" id="testimonial">
		<div class="auto-container">
			...
			<div class="sec-title centered">
				...
				<div class="separater"></div>
				<div class="text">Grow your traffic and draw customers to your business We couldn't <br> put it better than our users.</div>
			</div>
				...
				<div class="content-column col-lg-6 col-md-12 col-sm-12">
					<div class="inner-column">
						...
						<div class="sec-title">
							<h2>Get The App</h2>
							<div class="separater"></div>
							<div class="text">Grow your traffic and draw customers to your business <br> We couldn't put it better than our users.</div>
						</div>
						<div class="btns-box">
